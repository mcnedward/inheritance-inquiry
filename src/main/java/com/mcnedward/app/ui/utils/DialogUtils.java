...
public class DialogUtils {
    ...
    public static void loadDialogs() {
        ...
        if (mNocInfoDialog == null)
            mNocInfoDialog = new InfoDialog(InheritanceInquiry.PARENT_FRAME, NOC_TITLE, NOC_MESSAGE);
        if (mWmcInfoDialog == null)
            mWmcInfoDialog = new InfoDialog(InheritanceInquiry.PARENT_FRAME, WMC_TITLE, WMC_MESSAGE);
    }
